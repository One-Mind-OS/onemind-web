from typing import Literal, Optional import re

def note( command: str, path: Optional\[str\] = None, content:
Optional\[str\] = None, old_str: Optional\[str\] = None, new_str:
Optional\[str\] = None, new_path: Optional\[str\] = None, insert_line:
Optional\[int\] = None, query: Optional\[str\] = None, search_type: str
= "label", ) -\> str: \"\"\" Manage notes in your vault. All notes are
automatically scoped to your agent.
