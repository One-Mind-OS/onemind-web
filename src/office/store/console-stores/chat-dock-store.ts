...
import type { GatewayAdapter } from "@/office/gateway/adapter";
import { getAdapter } from "@/office/gateway/adapter-provider";
import type { SessionInfo } from "@/office/gateway/adapter-types";
import type { GatewayEventFrame } from "@/office/gateway/types";
import i18n from "@/office/i18n";
import { localPersistence } from "@/office/lib/local-persistence";
import { generateMessageId } from "@/office/lib/message-utils";
