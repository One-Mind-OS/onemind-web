...
import { getAdapter, waitForAdapter } from "@/office/gateway/adapter-provider";
import type { SkillInfo, SkillInstallResult } from "@/office/gateway/adapter-types";
import i18n from "@/office/i18n";
import { useConfigStore } from "@/office/store/console-stores/config-store";
import { toastSuccess, toastError } from "@/office/store/toast-store";
