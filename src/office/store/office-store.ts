...
import { parseAgentEvent } from "@/office/gateway/event-parser";
...
import type {
  ...
  ViewMode,
  VisualAgent,
} from "@/office/gateway/types";
import { ZONES, CORRIDOR_ENTRANCE } from "@/office/lib/constants";
import { allocatePosition, calculateLoungePositions } from "@/office/lib/position-allocator";
import {
  planWalkPath,
  calculateWalkDuration,
  interpolatePathPosition,
} from "@/office/lib/movement-animator";
