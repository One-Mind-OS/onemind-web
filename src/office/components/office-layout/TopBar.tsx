...
import { LanguageSwitcher } from "@/office/components/office-shared/LanguageSwitcher";
import type { ConnectionStatus, ThemeMode, ViewMode, PageId } from "@/office/gateway/types";
import { isWebGLAvailable } from "@/office/lib/webgl-detect";
