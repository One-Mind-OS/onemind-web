...
import { SpeechBubbleOverlay } from "@/office/components/overlays/SpeechBubble";
import type { VisualAgent } from "@/office/gateway/types";
import {
  SVG_WIDTH,
  SVG_HEIGHT,
  OFFICE,
  ...
  ZONE_COLORS,
  ZONE_COLORS_DARK,
} from "@/office/lib/constants";
import { calculateDeskSlots, calculateMeetingSeatsSvg } from "@/office/lib/position-allocator";
