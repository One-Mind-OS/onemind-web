...
import type { VisualAgent, AgentVisualStatus } from "@/office/gateway/types";
import { generateSvgAvatar, type SvgAvatarData } from "@/office/lib/avatar-generator";
import { STATUS_COLORS, AVATAR } from "@/office/lib/constants";
