...
import { resolveGatewayConnectionConfig } from "@/office/lib/gateway-url";
import { REDACTED_SENTINEL } from "@/office/lib/provider-types";
...
export function DeveloperSection() {
  ...
  const gatewayConnection = resolveGatewayConnectionConfig(
    injected?.gatewayUrl || process.env.NEXT_PUBLIC_GATEWAY_URL,
    injected?.gatewayToken || process.env.NEXT_PUBLIC_GATEWAY_TOKEN,
    window.location,
    { preferSameOriginProxy: process.env.NODE_ENV === 'development' },
  );
