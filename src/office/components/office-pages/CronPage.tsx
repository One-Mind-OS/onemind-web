...
import { CronStatsBar } from "@/office/components/office-console/cron/CronStatsBar";
import { CronTaskCard } from "@/office/components/office-console/cron/CronTaskCard";
import { CronTaskDialog } from "@/office/components/office-console/cron/CronTaskDialog";
...
import { useCronStore } from "@/office/store/console-stores/cron-store";
...
export function CronPage() {
  ...
  const handleToggle = (id: string, enabled: boolean) => {
    updateTask(id, { enabled } as Partial<import("@/office/gateway/adapter-types").CronTaskInput>);
  };
