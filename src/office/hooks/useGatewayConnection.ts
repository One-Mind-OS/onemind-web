...
import { initAdapter, isMockMode } from "@/office/gateway/adapter-provider";
import { GatewayRpcClient } from "@/office/gateway/rpc-client";
import type {
  AgentEventPayload,
  AgentSummary,
  AgentsListResponse,
...
import { GatewayWsClient } from "@/office/gateway/ws-client";
import { EventThrottle } from "@/office/lib/event-throttle";
