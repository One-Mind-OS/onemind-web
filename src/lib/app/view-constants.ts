...
export const VIEW_EMPTY_STATES: Record<Exclude<AppView, 'agents' | 'home' | 'office'>, { icon: string; title: string; description: string; features: string[] }> = {
  org_chart: {
    icon: 'git-branch',
    title: 'Org Chart',
...
export const FULL_WIDTH_VIEWS = new Set<AppView>([
  'home', 'org_chart', 'office', 'inbox', 'chatrooms', 'protocols', 'schedules', 'missions', 'secrets', 'providers', 'skills',
